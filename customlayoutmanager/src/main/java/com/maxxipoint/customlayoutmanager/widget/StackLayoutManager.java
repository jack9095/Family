package com.maxxipoint.customlayoutmanager.widget;
...
public class StackLayoutManager extends RecyclerView.LayoutManager {
    ...
    private StackLayoutManager(Builder builder) {
...
// onceCompleteScrollLength) / (onceCompleteScrollLength * 1.0f));
    ...
    public static class Builder {
        ...
        public StackLayoutManager build() {
    ...
    public interface TrasitionListener {
         ...
         */
        void handleLayerView(StackLayoutManager focusLayoutManager, View view, int viewLayer,
         ...
         * @param offset             当次滑动偏移量
         */
        void handleFocusingView(StackLayoutManager focusLayoutManager, View view, int position,
         ...
         * @param offset             当次滑动偏移量
         */
        void handleNormalView(StackLayoutManager focusLayoutManager, View view, int position,
                              float fraction, float offset);
    }
